...
<br>
<br>
Para este apartado y el siguiente, procederemos a hacer un breve análisis que va desde dentro de España hacia afuera, terminando con una visión general sobre algunos datos.
...
data.ahorro.es.plot <- data.ahorro.es %>% 
  ...
  labs(
    title = "Nivel de ahorro per cápita por comunidad (España)",
    x = NULL,
...
data.imp.yeoj <- data %>% 
  ...
  rename(Renta = B6N,
    ...
    geom_smooth(method = lm, se = FALSE) + 
      labs(x = "Renta (€/HAB)",
           y = "Impuestos pagados (€/HAB)") + 
      theme_bw(base_size = 14) + 
      labs(title = "Relación entre renta neta e impuestos pagados por países (2022)") + 
      theme_bw(base_size = 12)
...
data.tb.matrizcorr %>% 
  ...
  layout(title = "Correlación de indicadores por países")
