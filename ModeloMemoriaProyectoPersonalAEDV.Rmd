...
Vamos a observar con un mapa de calor los impuestos en millones de euros que ha ido pagando cada país (como conjunto) desde 2016 hasta 2022.
...
datatop10.imp %>%
  ...
  scale_fill_gradient(low = "white", 
                      high = "steelblue") +
geom_text(aes(label = round(values,1)), color = "black") +
  labs(title="Impuestos pagados por país en millones de euros",
       subtitle = "2016-2022",
       x="Año",
       y="País")
```
